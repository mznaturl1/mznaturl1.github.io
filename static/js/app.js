...
function init() {
    ...
    // Arrays for sample_values, otu_ids, and otu_label
    ...
    //Plot the weekly washing frequency in a gauge chart and get first ID's wash freq.
    ...
    // Trace for gauge chart and pointer
    var dataGauge = [
        {
          type: "scatter",
          x: [0],
  ...
  function updatePlotly(id) {
    d3.json("https://2u-data-curriculum-team.s3.amazonaws.com/dataviz-classroom/v1.1/14-Interactive-Web-Visualizations/02-Homework/samples.json").then(function (data) {
      ...
      var layoutGauge = {
        ...
        // Create the trace and bubble chart
        var trace2 = {
